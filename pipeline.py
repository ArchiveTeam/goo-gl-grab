...
LUA_SHA1 = get_hash(os.path.join(CWD, 'goo-gl.lua'))
...
class WgetArgs(object):
    def enumerate_ids(self, pattern):
        if '*' not in pattern:
            yield pattern
            return None
        for c in string.digits + string.ascii_letters:
            i = pattern.index('*')
            yield from self.enumerate_ids(pattern[:i]+c+pattern[(i+1):])
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type in mapping:
                ...
                warc_header = 'id' if len(mapped) == 0 else mapped
...
project = Project(
    ...
    project_html='''
        ...
        <h2>goo.gl <span class="links"><a href="https://goo.gl/">Website</a> &middot; <a href="https://tracker.archiveteam.org/goo-gl/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/goo.gl">Wiki</a></span></h2>
